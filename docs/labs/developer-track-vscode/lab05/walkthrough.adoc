...
:next-lab-url: https://tutorial-web-app-webapp.{openshift-app-host}/tutorial/dayinthelife-integration.git-developer-track-vscode-lab06/
...
[id='manage-endpoint']
= Developer Lab 5 VSCODE - Managed API Endpoints
